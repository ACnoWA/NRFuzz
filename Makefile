...
DYN_ROOT 	= /data/liyi/Programs/dyninst101/thirdparty/dyninst-10.1.0/install
...
PROGS       = collafl libCollAFLDyninst CollAFLDyninst afl-showmap neuzz
SH_PROGS    = afl-plot

CFLAGSS    = -O3 -funroll-loops
